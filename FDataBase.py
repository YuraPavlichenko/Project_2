...
class FDataBase:
    def __init__(self, db):
        self.__db = db  # Посилання на зв'язок з бд
        self.__cur = db.cursor()  # Через курсор ми працюємо з таблицями бд
    ...
    def getMenu(self):
        ...
        try:
            ...
            print("Помилка при читанні з бд")
        return []
    ...
    def addPost(self, title, text, url):
        try:
            ...
            print("Помилка додавання статті в бд " + str(e))
            return False
    ...
    def addUser(self, name, email, hpsw):
        try:
            ...
            print("Помилка при додаванні в БД " + str(e))
            return False
    ...
    def getUser(self, user_id):
        try:
            ...
            print("Помилка отриманні з БД " + str(e))
